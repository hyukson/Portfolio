...
const AboutMe = () => {
  const codes: string[] = [
    ...
    "",
    "공부하고 배운점을 <span class='pink'>공유하고 기록</span> 하는 것을 좋아하는 꿈나무입니다.", 
    ...
    "      수상이력: [ <span class='lightGreen'>' 제57회 전국기능경기대회 웹 개발 부문 은메달 '</span>, <span class='lightGreen'>' 2021 경기도지방기능경기대회 웹 개발 부문 금메달 '</span> ],",
    "    }",
    "&lt/<span class='script'>script</span>&gt",
  ];
